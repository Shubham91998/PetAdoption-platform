...
const Process = () => {
  ...
  const steps = [
    ...
    { title: "💪 Accepted", description: "Your application has been accepted by the admin. Congratulations, you are one step closer to adopting your new pet!", key: "Accepted" },
  ];
          ...
          <div
            ...
            className={`p-4 border border-gray-300 rounded-lg ${
              status === "Rejected" && step.key === "Rejected"
                ...
                : status === "Accepted" && step.key === "Accepted"
