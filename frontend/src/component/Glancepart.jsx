    ...
    const fetchPetCount = async () => {
      try {
        const res = await axios.get(
          "http://localhost:4001/pets/api/pet-requests"
        );
        console.log("Fetched pet requests length:", res.data.length);
        setTotalPets(res.data.data.length);
        console.log(totalPets) // Get the length of the fetched array
            ...
            <div className="display flex gap-10 sm:justify-between sm:mx-5">
              <div id="adoption-applications" className="">
                <h3
                  ...
                  className="flex px-7 sm:justify-center sm:items-center py-2"
                >
                  {totalPets}
                </h3>
              ...
              <div id="dogs-adopted" className="stat-item">
                <h3
                  id="dogs-adopted"
                  className="flex px-5 sm:justify-center sm:items-center py-2"
                >
                  0
                </h3>
                <p>Dogs Adopted</p>
